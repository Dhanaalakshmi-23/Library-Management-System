...
scheduler_events = {
    "daily": [
        "library_management.library_management.scheduler.send_membership_expiry_reminder",
        "library_management.library_management.scheduler.auto_expire_memberships"
    ]
}
